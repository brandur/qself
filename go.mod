module github.com/brandur/qself

go 1.16

// replace github.com/brandur/wanikaniapi => /Users/brandur/Documents/projects/wanikaniapi

require (
	github.com/brandur/wanikaniapi v0.0.0-20210119045936-473a10f36f28 // indirect
